...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            <h6 class="section-title text-center text-primary text-uppercase">A nossa Equipa</h6>
            <h1 class="mb-5">Explore os nossos <span class="text-primary text-uppercase">Staffs</span></h1>
        </div>
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="rounded shadow overflow-hidden">
                    <div class="text-center p-4 mt-3">
                        <h5 class="fw-bold mb-0">Diana Catarino</h5>
                        <small>2220863</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded shadow overflow-hidden">
                    <div class="text-center p-4 mt-3">
                        <h5 class="fw-bold mb-0">Maria Jesus</h5>
                        <small>2211923</small>
                    </div>
                </div>
            </div>
