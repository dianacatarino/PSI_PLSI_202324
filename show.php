...
<div class="detalhes-alojamento">
    ...
    <div class="mt-3">
        ...
        <form>
            <?php $form = ActiveForm::begin(['action' => ['comentarios/create'], 'method' => 'post', 'options' => ['class' => 'container']]); ?>
            <div class="mb-3">
            ...
            <div class="d-flex justify-content-between">
                <?= Html::a('Adicionar Feedback', ['alojamentos/show', 'id' => $fornecedor->id], ['class' => 'btn btn-primary btn-sm']) ?>
